...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF0C5854);
  late Color secondary = const Color(0xFFF68F05);
  late Color tertiary = const Color(0xFFEE8B60);
  late Color alternate = const Color(0xFFEDEDED);
  late Color primaryText = const Color(0xFF232424);
