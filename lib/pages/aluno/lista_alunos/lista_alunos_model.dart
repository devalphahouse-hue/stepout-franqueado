...
class ListaAlunosModel extends FlutterFlowModel<ListaAlunosWidget> {
  ...
  final paginatedDataTableController =
      FlutterFlowDataTableController<ListaAlunosStruct>();

  /// Query cache managers for this widget.

  final _listaAlunosManager = FutureRequestManager<ApiCallResponse>();
  Future<ApiCallResponse> listaAlunos({
    String? uniqueQueryKey,
    bool? overrideCache,
    required Future<ApiCallResponse> Function() requestFn,
  }) =>
      _listaAlunosManager.performRequest(
        uniqueQueryKey: uniqueQueryKey,
        overrideCache: overrideCache,
        requestFn: requestFn,
      );
  void clearListaAlunosCache() => _listaAlunosManager.clear();
  void clearListaAlunosCacheKey(String? uniqueKey) =>
      _listaAlunosManager.clearRequest(uniqueKey);
