                                                      ...
                                                      children: [
                                                        ...
                                                        FutureBuilder<
                                                          ...
                                                          builder: (context,
                                                            ...
                                                            final containerProfListaProfessoresResponse =
                                                                snapshot.data!;
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Row(
                                                                        ...
                                                                        children:
                                                                            [
                                                                          Text(
                                                                            '${DetalhesAulaStruct.maybeFromMap(colContentDetalhesAulaResponse.jsonBody)?.professorResponsavelNome}',
                                                                                ...
                                                                                children: [
                                                                                  Expanded(
                                                                                    child: FlutterFlowDropDown<String>(
                                                                                      ...
                                                                                      options: List<String>.from((containerProfListaProfessoresResponse.jsonBody.toList().map<ListaProfessoresStruct?>(ListaProfessoresStruct.maybeFromMap).toList() as Iterable<ListaProfessoresStruct?>).withoutNulls.map((e) => e.userId).toList()),
                                                                                      optionLabels: (containerProfListaProfessoresResponse.jsonBody.toList().map<ListaProfessoresStruct?>(ListaProfessoresStruct.maybeFromMap).toList() as Iterable<ListaProfessoresStruct?>).withoutNulls.map((e) => e.nome).toList(),
                                                      ...
                                                      onPressed: () async {
                                                        ...
                                                        if ((_model.apiResulthcv
                                                          ...
                                                          await AulasTable()
                                                              .update(
                                                            data: {
                                                              'alunos_convidados': DetalhesAulaStruct
                                                                      .maybeFromMap(
                                                                          colContentDetalhesAulaResponse
                                                                              .jsonBody)
                                                                  ?.alunosConvidados
