...
class _CadastroFranquiaWidgetState extends State<CadastroFranquiaWidget> {
  ...
  void initState() {
    ...
    _model.textFieldCPFMask2 = MaskTextInputFormatter(mask: '###.###.###-##');
                                      ...
                                      children: [
                                                ...
                                                children: [
                                                  ...
                                                  if (_model.dropDownValue ==
                                                    ...
                                                    Container(
                                                      ...
                                                      child: TextFormField(
                                                        controller: _model
                                                            .textFieldCPFTextController3,
                                                        focusNode: _model
                                                            .textFieldCPFFocusNode3,
                                                        autofocus: false,
                                                        obscureText: false,
                                                        decoration:
                                                            InputDecoration(
                                                        ...
                                                        cursorColor:
                                                            FlutterFlowTheme.of(
                                                                ...
                                                                .primaryText,
                                                        validator: _model
                                                            .textFieldCPFTextController3Validator
                                                            .asValidator(
                                                                context),
                                                      ),
                                                    ),
                                        ...
                                        FFButtonWidget(
                                          onPressed: () async {
                                            ...
                                            _model.novoRowFranquia =
                                                await FranquiasTable().insert({
                                              'razao_social': _model
                                                  .textFieldNomeTextController2
                                                  .text,
                                              'status_franquia': false,
                                              'user_responsavel':
                                                  _model.novoRowUser?.id,
                                              'id-indicacao': FFAppState()
                                            ...
                                            await MetaUserFranquiaTable()
                                                .insert({
                                              'level': 'ADMIN',
                                              'id_franquia':
                                                  _model.novoRowFranquia?.id,
