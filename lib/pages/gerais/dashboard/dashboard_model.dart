...
class DashboardModel extends FlutterFlowModel<DashboardWidget> {
  ...
  final _bannerFranqueadoManager = FutureRequestManager<List<BannersRow>>();
  Future<List<BannersRow>> bannerFranqueado({
    String? uniqueQueryKey,
    bool? overrideCache,
    required Future<List<BannersRow>> Function() requestFn,
  }) =>
      _bannerFranqueadoManager.performRequest(
        uniqueQueryKey: uniqueQueryKey,
        overrideCache: overrideCache,
        requestFn: requestFn,
      );
  void clearBannerFranqueadoCache() => _bannerFranqueadoManager.clear();
  void clearBannerFranqueadoCacheKey(String? uniqueKey) =>
      _bannerFranqueadoManager.clearRequest(uniqueKey);
