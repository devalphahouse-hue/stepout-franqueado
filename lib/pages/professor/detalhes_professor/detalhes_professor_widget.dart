                                                      ...
                                                      Align(
                                                        alignment:
                                                            AlignmentDirectional(
                                                                -1.0, -1.0),
                                                        child: Text(
                                                          'Turmas podem ser vinculadas posteriormente na tela de “Detalhes do Professor”.',
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                                                              .bodySmall
                                                              .override(
                                                            ...
                                                            child: FutureBuilder<
                                                              ...
                                                              builder: (context,
                                                                ...
                                                                return FlutterFlowDropDown<
                                                                    String>(
                                                                  controller: _model
                                                                          .dropDownTurmasValueController ??=
                                                                      FormFieldController<
                                                                          String>(
                                                                    _model.dropDownTurmasValue ??=
                                                                        '0',
                                                                  ),
                                                                  options: List<
                                                                          String>.from(
                                                                      dropDownTurmasTurmasRowList
                                                                          .map((e) =>
                                                                              e.id)
                                                                          .toList()),
                                                                  optionLabels: dropDownTurmasTurmasRowList
                                                                      .map((e) =>
                                                                          e.nomeDaTurma)
                                                                      .withoutNulls
                                                                      .toList(),
                                                                  ...
                                                                  builder: (context,
                                                                    ...
                                                                    return ListView
                                                                      ...
                                                                      itemBuilder:
                                                                          (context,
                                                                              turmasIndex) {
                                                                        final turmasTurmasRow =
                                                                            turmasTurmasRowList[turmasIndex];
                                                                        return Row(
                                                                          mainAxisSize:
                                                                              MainAxisSize.max,
                                                                          children:
                                                                              ...
                                                                              onTap: () async {
                                                                                var confirmDialogResponse = await showDialog<bool>(
                                                                                      ...
                                                                                      builder: (alertDialogContext) {
                                                                                        return WebViewAware(
                                                                                          child: AlertDialog(
                                                                                            title: Text('Tem certeza que quer desvincular essa turma?'),
                                                                                            actions: [
                                                                                              TextButton(
