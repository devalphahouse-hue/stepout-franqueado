...
import 'dart:ui';
import '/index.dart';
import 'adicionar_turma_widget.dart' show AdicionarTurmaWidget;
...
class AdicionarTurmaModel extends FlutterFlowModel<AdicionarTurmaWidget> {
  ...
  TurmasRow? turmaCriada;
  // Stores action output result for [Backend Call - API (CriarAula)] action in Button widget.
  ApiCallResponse? apiPrimeiraAulaCriada;
